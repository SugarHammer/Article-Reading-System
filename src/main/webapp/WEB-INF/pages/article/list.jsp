...
<head>
    ...
    <script>
            ...
            // prompt("输入您的姓名"); // 这个显示内容也可以不写，但就没有交互的意义了。
            var name0=prompt("输入您的姓名","坤坤"); //显示默认文本 "Keafmd"

            // 方式二
            var x;
            var name=prompt("请输入打卡时间","2025-03-20"); //显示默认文本 "Keafmd"
            if (name!=null && name!=""){
            // x="你好! " + name + "。";
            x="你好" + name0 + "同学!"+"  "+"打卡时间："+name;
            document.write(x)
        }
    </script>
</head>
                ...
                <c:forEach var="article" items="${articles}" varStatus="s">
                    <li>
                        ...
                        <div class="bloginfo"><span class="blogpic"><a href="#" title=""><img
                                src="<c:url value="/titleImg/${s.index}.jpg"/> "/></a></span>
                        ...
                        <div class="autor"><span class="lm f_l"><a href="#">${article.author}</a></span><span
                            ...
                            <!-- 关注点8:发送动态URL-->
                            <a
                                    href="<c:url value="/actions/article/readArticle/${article.id}"/> " class="more"
...
<footer>
    <p>Design by <a href="#">开发者：XXX</a></p>
</footer>
</body>
</html>
