...
/**
 * Created by jay.zhou on 2018/3/19.
 */
@Controller
public final class ArticleController extends AbstractController {
    ...
    /**
     * 去所有阅读展示页面，这个是去阅读空间的主页
     *
     * @return 携带上阅读的参数，去阅读首页
     */
    ...
    /**
     * 去阅读详情页面
     * 根据URL路径中指定的阅读ID号，去获取制定阅读的内容
     *
     * @param articleId 指定的阅读的ID号
     * @return 获取此阅读的数据，并去阅读详情页面
     */
    ...
    public ModelAndView myBlogSpace(HttpSession session) {
        ...
        //获取阅读排行的阅读,根据点击量click降序DESC获取阅读
     ...
     *
     * @param conditionValue 参数是什么，作者还是阅读ID？
     ...
     * 删除阅读
     *
     * @param request  request对象，用于获取阅读的articleId
